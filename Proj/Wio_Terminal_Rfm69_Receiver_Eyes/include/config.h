...
#define SCREEN_OFF_TIME_MINUTES  1      // Switch screen a little bit dark after this time
#define SCREEN_DARK_TIME_MINUTES 30     // Switch screen very dark after this time
